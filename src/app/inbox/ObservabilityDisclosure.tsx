...
type Trace = { run: { status: string; round: number; startedAt: number; updatedAt: number } | null; usage: { inputTokens: number; outputTokens: number; totalTokens: number; estimatedCostUsd: number | null }; activities: Array<{ at: number; label: string; detail: string }> } | null;
