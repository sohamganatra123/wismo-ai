...
type Run = { id: string; caseId: string | null; status: string; trigger: string; round: number; startedAt: number; updatedAt: number; currentStep: { name: string; kind: string; status: string } | null };
